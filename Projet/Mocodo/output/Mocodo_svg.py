#!/usr/bin/env python
# encoding: utf-8
# Généré par Mocodo 2.3.7 le Thu, 21 Feb 2019 20:03:46
...
with codecs.open(".\output\Mocodo.svg", "w", "utf8") as f:
    f.write(lines)
safe_print_for_PHP(u'Fichier de sortie ".\output\Mocodo.svg" généré avec succès.')